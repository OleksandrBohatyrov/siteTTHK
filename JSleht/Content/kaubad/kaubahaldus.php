        ...
        <?php foreach($kaubad as $kaup): ?>
            <tr>
                <?php if(isSet($_REQUEST["muutmisid"]) &&
                    ...
                    <td><a href="kaubahaldus.php?kustutusid=<?=$kaup->id ?>"  onclick="return confirm('Kas ikka soovid kustutada?')">Kustuta</a>  <a href="kaubahaldus.php?muutmisid=<?=$kaup->id ?>">Muuda</a>  </td>
                    <td><?=$kaup->nimetus ?></td>
